        ...
        if ($company !== null) {
            $company = $company->map(function ($item) {
                return [
                    ...
                    "logo" => $item->logo !== null ? "/storage/companies/company-" . $item->id . '/' . $item->logo : null,
                    "company_stamp" => $item->company_stamp !== null ? "/storage/companies/company-" . $item->id . '/' . $item->company_stamp : null,
                    "status" => $item->status,
